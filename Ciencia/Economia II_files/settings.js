...
theme_advanced_buttons1 : 				"lshselect,bold,italic,underline,strikethrough,forecolor,backcolor,|,bullist,numlist,|,undo,redo,|,lslink,unlink,lsquote,lsvideo,lsimage,pagebreak",
			...
			theme_advanced_statusbar_location : 	"bottom",
                ...
                plugins : "lseditor,safari,inlinepopups,pagebreak,pagebreakline,fullscreen,emotions,table,autoresize",
                convert_urls : false,
                extended_valid_elements : "embed[src|type|allowscriptaccess|allowfullscreen|width|height]",
                pagebreak_separator :"<cut>",
                media_strict : false,
                height: "400px",
                autoresize_min_height: "400px",
	...
	this.getTinymceComment = function() {
		return {
			...
			theme_advanced_toolbar_location : 		"top",
			theme_advanced_toolbar_align : 			"left",
			theme_advanced_buttons1 : 				"bold,italic,underline,strikethrough,forecolor,backcolor,lslink,unlink,lsquote,lsvideo,lsquote,lsimage,code",
